...
![Typical PATH Weekend routing over the last 20 years](media/image2.png)
...
![New PATH Weekend routing](media/image1.png)
...
| **Out-west Total** | **25,264** | **10,770** | **8,645** |
| **Jersey City Area** |
...
I commend the Port Authority for providing 10-minute weekend service to Hoboken (though they should make it permanent rather than calling it "temporary additional service"). However, they must also increase train frequency in the downtown tunnels to WTC.
...
The current 33rd Street to Journal Square weekend routing provides no benefit to Jersey City residents. For comparison, the A train traverses the entire length of Manhattan in nearly the same time it takes PATH to travel from 33rd Street to Journal Square with this routing. The Port Authority should eliminate the Journal Square-33rd Street weekend service entirely, enhance Hudson-Bergen Light Rail service to connect Newport to Exchange Place and Hoboken, and redirect that capacity to WTC service.
